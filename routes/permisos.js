...
const db = require("../db"); // tu pool/connection mysql2
...
// GET /permisos/rol/:id_rol - obtiene permisos asignados a un rol
...
// POST /permisos/asignar - asigna o actualiza permisos para un rol y permiso
